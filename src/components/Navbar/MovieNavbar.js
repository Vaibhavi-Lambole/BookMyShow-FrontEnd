       ...
       <>
        <div className="text-white flex items-center justify-between">
            <div>
                ...
                <BiShareAlt className="w-full h-full cursor-pointer" />
            </div>
    </div>
...
//             <input type="search" class="w-full focus:outline-none" placeholder="Search For movies, events , plays, sports and activities"/>
//         </div>
//     )
// };
...
const NavLg = () => {
    return(
        <>
        <div className="container mx-auto px-4 flex items-center justify-between select-none">
            <div className="flex items-center w-1/2">
                <div className="w-1/2 h-1/2 px-5">

                   {/* <a href="#" className="w-full h-full text-white tracking-wider text-3xl subpixel-antialiased" target="_blank">book<span className="text-white bg-red-600 ">my</span>show</a> */}
             ...
             <div className="w-full flex items-center bg-white gap-3 px-3 py-2 rounded-sm" >
                 ...
                 <BiSearch />
                 <input type="search" className="w-full focus:outline-none" placeholder="Search for movies, events, plays,sports and activites " />
             </div>
            </div>
